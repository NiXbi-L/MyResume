...
const CURRENT_FOCUS = {
  ...
  intro:
    'Развиваю сервис виртуальной примерки и рекомендации; движок рекомендаций уже в первой версии, дальше — итерации по качеству сигнала с фото.',
  bullets: [
    'Сервис примерки на FastAPI: пайплайн от входных данных до результата, интеграция с генеративными моделями и настройка промптов.',
    'Рекомендации: реализована первая версия движка на основе стиля и цветов.',
    'Пока мешает фон на изображении вещи — алгоритм его подхватывает и путается. Во второй версии в планах учесть фон при минимальной стоимости ресурсов на этот этап обработки.',
  ],
};
