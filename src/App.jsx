...
const SKILL_GROUPS = [
  ...
  },
  {
    ...
    items: [
      'LLM: API, интеграции',
      'Cursor IDE и другие ИИ-инструменты — для кода, уточнения задач и поиска информации вместе с обычными поисковиками',
      'Git / GitHub',
        ...
        <header className="hero">
          ...
          <div className="hero__text">
            ...
            <p className="hero__tagline hero__tagline--second">
              Не позиционирую себя как отдельного дизайнера или сеньор-фронтендера: визуал и интерфейс делаю
              аккуратно и по делу. В работе постоянно использую <strong>Cursor</strong> и другие ИИ-модели наряду с
              обычным поиском и документацией.
            </p>
